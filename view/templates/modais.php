	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle"><i class="fas fa-edit"></i>Configuração de gerenciadores</h5>
			...
			<div class="modal-body">
				<form>
					<div id="msgAltGerenciador" class= "text-center alert alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><p>Alo</p></div>
					<div class="form-group">
						<label for="mac" class="col-form-label">Endereço MAC:</label>
						<input type="text" class="form-control" id="macE">
					</div>
					<div class="form-group">
						<label for="ip" class="col-form-label" disabled>IP:</label>
						<input type="text" class="form-control" id="ipE" >
					</div>

					<div class="form-group">
						<label for="message-text" class="col-form-label">Descrição:</label>
						<textarea class="form-control" id="descE"></textarea>
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary"  data-dismiss="modal">Fechar</button>
				<button type="button" class="btn btn-success" id="altGerenciador">Atualizar</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="altEq">
					<div id="erroE"  class="alert alert-dismissible">
...
<!--  Modal Gerenciador -->
<div class="modal fade" id="exampleModalGerenciador" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
